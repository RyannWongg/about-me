...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div
        className="absolute left-6 md:left-16 top-1/2 z-5 pointer-events-none will-change-transform"
        style={{ transform: `translateY(-50%) translateX(${slideAmount}px)` }}
      >
        <h2 className="text-[20vw] md:text-[15vw] font-bold text-white/50 tracking-tight leading-none">
          RYAN
        </h2>
      </div>
      ...
      <div className="absolute inset-0 z-20">
        ...
        <div
          className="absolute bottom-0 md:bottom-8 right-6 md:right-16 pointer-events-none will-change-transform"
        ...
        <div className="absolute right-[18%] md:right-[10%] top-1/2 -translate-y-1/2 text-right max-w-xs md:max-w-sm">
          {/* Subtitle */}
          <p className="font-mono-refined text-[10px] md:text-[11px] text-slate-300 tracking-[0.25em] uppercase font-bold mb-4">
            Math, Statistics & CS @ UofT
          </p>

          {/* Decorative Line */}
          <div className="w-32 md:w-48 h-px bg-gradient-to-l from-slate-400 to-transparent mb-4 ml-auto"></div>

          {/* Brief Description */}
          <p className="font-body-refined text-slate-300 text-[13px] md:text-[14px] leading-[1.7] mb-6">
          ...
          <div className="flex items-center gap-3 justify-end">
            <a
              ...
              className="p-2.5 rounded-full bg-white/10 hover:bg-[#39ff14] text-white hover:text-slate-900 transition-all duration-300"
            >
              <Github size={18} />
            </a>
            <a
